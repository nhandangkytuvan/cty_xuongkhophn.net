...
<div class="baner">
	<div class="slick-home">
		<div><img src="<?php echo e(asset('public/images/desktop/slide-1.png')); ?>" alt="" class="center-block"></div>
	</div>
</div>
<main class="container home">
	...
	<div class="flex flex2 justify-content-between">
		<div class="flex2col1">
			...
			<div class="flex flex3 justify-content-between">
				...
				<div class="flex3col2">
					<img src="<?php echo e(asset('public/images/desktop/home-4.png')); ?>" alt="">
				</div>
			</div>
		</div>
		<div class="flex2col2">
			<h2></h2>
			<img src="<?php echo e(asset('public/images/desktop/home-3.png')); ?>" class="center-block">
			<div class="order3">
	...
	<div style="margin-top: 40px;">
		<img src="<?php echo e(asset('public/images/desktop/home-5.png')); ?>" class="center-block">
	</div>
	<div class="tabs-1">
		...
		<div class="flex flex8 justify-content-center">
			<div class="flex8col1">
				<div class="flex flex9">
					<div class="flex9col1">
						<img src="<?php echo e(asset('public/images/desktop/home-6.png')); ?>" alt="">
					</div>
					<div class="flex9col2">
						<img src="<?php echo e(asset('public/images/desktop/jbzq5.jpg')); ?>" class="active">
						<img src="<?php echo e(asset('public/images/desktop/jbzq10.jpg')); ?>" class="">
						<img src="<?php echo e(asset('public/images/desktop/jbzq11.jpg')); ?>" class="">
						<img src="<?php echo e(asset('public/images/desktop/jbzq12.jpg')); ?>" class="">
						<img src="<?php echo e(asset('public/images/desktop/jbzq13.jpg')); ?>" class="">
						<img src="<?php echo e(asset('public/images/desktop/jbzq14.jpg')); ?>" class="">
					</div>
				</div>
			</div>
			<div class="flex8col2">
			...
			<div class="flex8col3">
				<img src="<?php echo e(asset('public/images/desktop/home-7-2.png')); ?>" alt="">
			</div>
		</div>
	</div>
	...
	<div class="flex flex12 justify-content-between" style="border-bottom: 1px dashed #e0e0e0;padding-bottom: 20px;">
		<div class="flex12col1">
			<h4><a href=""><img src="<?php echo e(asset('public/images/desktop/home-8-1.png')); ?>" alt=""></a></h4>
		</div>
	...
	<div class="flex flex12 justify-content-between" style="border-bottom: 1px solid #e0e0e0;padding-bottom: 40px;">
		<div class="flex12col1">
			<h4><a href=""><img src="<?php echo e(asset('public/images/desktop/home-8-2.png')); ?>" alt=""></a></h4>
		</div>
		<div class="flex12col2">
			<div>
	...
	<div>
		<h3 style="margin-top: 37px;"><img src="<?php echo e(asset('public/images/desktop/home-9.png')); ?>" class="center-block"></h3>
		<div class="flex flex13 justify-content-between">
			...
			<div class="flex13col2">
				<div class="active">
					<img src="<?php echo e(asset('public/images/desktop/home-9-1.png')); ?>" alt="">
				</div>
				<div>
					<img src="<?php echo e(asset('public/images/desktop/home-9-3.png')); ?>" alt="">
				</div>
				<div>
					<img src="<?php echo e(asset('public/images/desktop/home-9-4.png')); ?>" alt="">
				</div>
				<div>
					<img src="<?php echo e(asset('public/images/desktop/home-9-5.png')); ?>" alt="">
				</div>
			</div>
		</div>
	</div>
