...
document.writeln("      <li><a href=\"http://drt.zoosnet.net/LR/Chatpre.aspx?id=DRT84001515&lng=en\" target=\"_blank\">");
document.writeln("        <div class=\"sidebox\"><i class=\"dx\" name=\"dx\"></i><span style=\"font-size:13px\">Tư vấn<br>trực tuyến</span></div>");
document.writeln("        </a></li>");
document.writeln("      <li><a href=\"tel:0911.501.709\" target=\"_self\"><i class=\"dh js_ht\"></i>");
document.writeln("        <div class=\"ht ht_iphone\"></div>");
document.writeln("        </a></li>");

document.writeln("      <li><a href=\"http://khoaxuongkhop.net/dia-chi-phong-kham\" target=\"_blank\">");
