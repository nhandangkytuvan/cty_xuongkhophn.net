    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="post_description" rows="3"><?php echo e($data['post']->post_description); ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="post_keyword" rows="5"><?php echo e($data['post']->post_keyword); ?></textarea>
            </div>
            <div class="form-group">
