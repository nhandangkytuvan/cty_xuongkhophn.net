...
<div class="panel panel-default">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><a href="<?php echo e(url($post->post_alias.'/'.$post->id.'.htm')); ?>">
                <?php if($post->post_avatar): ?>
                <img src="<?php echo e(asset('public/img/'.$post->post_avatar)); ?>" class="img-responsive img-thumbnail" style="max-width: 90px;"></a>
                <?php else: ?>
                <img src="<?php echo e(asset('public/img/no-image.png')); ?>" class="img-responsive img-thumbnail" style="max-width: 90px;"></a>
                <?php endif; ?>
            </td>
