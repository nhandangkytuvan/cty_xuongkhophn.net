<div style="margin-bottom: 10px;">
    <form action="<?php echo e(url('admin/term/index')); ?>" class="form-inline">
                    ...
                    <div class="pull-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="border-radius: 0;right: 0;left: auto;">
                                ...
                                <li>
                                    <a href="<?php echo e(url('admin/term/edit/'.$term->id)); ?>">
                                        <span class="glyphicon glyphicon-pencil"></span> Sửa term
                                    </a> 
                                </li> 
                                <li>
                                    <a href="<?php echo e(url('admin/term/delete/'.$term->id)); ?>">
