                            ...
                            <div class="">
                                <div class="input-group">
                                    ...
                                    <select name="user_group" class="form-control">
                                        <option <?php echo e($data['user']->user_group=='admin' ? 'selected' : ''); ?> value="admin">Quản trị</option>
                                        <option <?php echo e($data['user']->user_group=='bien-tap' ? 'selected' : ''); ?> value="bien-tap">Biên tập</option>
                                        <option <?php echo e($data['user']->user_group=='seo' ? 'selected' : ''); ?> value="seo">Seo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" readonly name="username" value="<?php echo e($data['user']->username); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
