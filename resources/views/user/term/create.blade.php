    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="term_description" rows="3">{{ old('term_description') }}</textarea>
            </div>
            <div class="form-group">
                <label class="control-label">Keyword</label>
                <textarea type="text" class="form-control" name="term_keyword" rows="5">{{ old('term_keyword') }}</textarea>
            </div>
            <div class="form-group">
